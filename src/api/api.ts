...
export type AddCounselorReqRoleTypeEnum = typeof AddCounselorReqRoleTypeEnum[keyof typeof AddCounselorReqRoleTypeEnum];
...
export type AddReqCounselNeedStatusEnum = typeof AddReqCounselNeedStatusEnum[keyof typeof AddReqCounselNeedStatusEnum];
...
export type AddUserReqRoleEnum = typeof AddUserReqRoleEnum[keyof typeof AddUserReqRoleEnum];
...
export type SelectByCounselSessionIdResCounselNeedStatusEnum = typeof SelectByCounselSessionIdResCounselNeedStatusEnum[keyof typeof SelectByCounselSessionIdResCounselNeedStatusEnum];
...
export type UpdateReqCounselNeedStatusEnum = typeof UpdateReqCounselNeedStatusEnum[keyof typeof UpdateReqCounselNeedStatusEnum];
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        _delete: async (deleteReq: DeleteReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(deleteReq, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        add: async (addReq: AddReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(addReq, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        login: async (loginCounselorReq: LoginCounselorReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(loginCounselorReq, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        searchMedication: async (keyword: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        selectByCounselSessionId: async (counselSessionId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectByCounselSessionId', 'counselSessionId', counselSessionId)
            const localVarPath = `/v1/counsel/record`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        selectByCounselSessionId1: async (counselSessionId: string, counseleeId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectByCounselSessionId1', 'counselSessionId', counselSessionId)
            // verify required parameter 'counseleeId' is not null or undefined
            assertParamExists('selectByCounselSessionId1', 'counseleeId', counseleeId)
            const localVarPath = `/v1/counsel/counselee/{counselSessionId}`
         ...
         * @throws {RequiredError}
         */
        selectByCounselSessionId1_1: async (counselSessionId: string, counseleeId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectByCounselSessionId1_1', 'counselSessionId', counselSessionId)
            // verify required parameter 'counseleeId' is not null or undefined
            assertParamExists('selectByCounselSessionId1_1', 'counseleeId', counseleeId)
            const localVarPath = `/v1/counsel/counselee/{counselSessionId}`
                .replace(`{${"counselSessionId"}}`, encodeURIComponent(String(counselSessionId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        selectCounselCard_2: async (counselSessionId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectCounselCard_2', 'counselSessionId', counselSessionId)
            const localVarPath = `/v1/counsel/card/{counselSessionId}`
                .replace(`{${"counselSessionId"}}`, encodeURIComponent(String(counselSessionId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        selectCounselSessionList: async (baseDate?: string, cursor?: string, size?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        selectCounseleeConsent: async (counselSessionId: string, counseleeId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectCounseleeConsent', 'counselSessionId', counselSessionId)
            // verify required parameter 'counseleeId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        selectPreviousByCounselSessionId: async (counselSessionId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectPreviousByCounselSessionId', 'counselSessionId', counselSessionId)
         ...
         * @throws {RequiredError}
         */
        selectPreviousItemListByCounselSessionId: async (counselSessionId: string, informationName: string, informationItemName: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectPreviousItemListByCounselSessionId', 'counselSessionId', counselSessionId)
            // verify required parameter 'informationName' is not null or undefined
            assertParamExists('selectPreviousItemListByCounselSessionId', 'informationName', informationName)
            // verify required parameter 'informationItemName' is not null or undefined
            assertParamExists('selectPreviousItemListByCounselSessionId', 'informationItemName', informationItemName)
         ...
         * @throws {RequiredError}
         */
        selectPreviousListByCounselSessionId: async (counselSessionId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('selectPreviousListByCounselSessionId', 'counselSessionId', counselSessionId)
         ...
         * @throws {RequiredError}
         */
        update: async (updateReq: UpdateReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async _delete(deleteReq: DeleteReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResDeleteRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator._delete(deleteReq, options);
         ...
         * @throws {RequiredError}
         */
        async add(addReq: AddReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResAddRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.add(addReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.add']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async login(loginCounselorReq: LoginCounselorReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.login(loginCounselorReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async searchMedication(keyword: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListMedicationAutoCompleteDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchMedication(keyword, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.searchMedication']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectByCounselSessionId(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectByCounselSessionId1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectByCounselSessionId1(counselSessionId, counseleeId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectByCounselSessionId1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectByCounselSessionId1_1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectByCounselSessionId1_1(counselSessionId, counseleeId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectByCounselSessionId1_1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectCounselCard_2(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectCounselCardRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectCounselCard_2(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectCounselCard_2']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectCounselSessionList(baseDate?: string, cursor?: string, size?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonCursorResListSelectCounselSessionListItem>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectCounselSessionList(baseDate, cursor, size, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectCounselSessionList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectCounseleeConsent(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectCounseleeConsentRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectCounseleeConsent(counselSessionId, counseleeId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectCounseleeConsent']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectPreviousByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectPreviousByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectPreviousByCounselSessionId(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectPreviousByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectPreviousItemListByCounselSessionId(counselSessionId: string, informationName: string, informationItemName: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListSelectPreviousCounselCardItemListRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectPreviousItemListByCounselSessionId(counselSessionId, informationName, informationItemName, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectPreviousItemListByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async selectPreviousListByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListSelectPreviousListByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectPreviousListByCounselSessionId(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.selectPreviousListByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async update(updateReq: UpdateReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResUpdateRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.update(updateReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        _delete(deleteReq: DeleteReq, options?: RawAxiosRequestConfig): AxiosPromise<CommonResDeleteRes> {
            return localVarFp._delete(deleteReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 복약 상담 추가
         ...
         * @throws {RequiredError}
         */
        add(addReq: AddReq, options?: RawAxiosRequestConfig): AxiosPromise<CommonResAddRes> {
            return localVarFp.add(addReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 상담 카드 등록
         ...
         * @throws {RequiredError}
         */
        login(loginCounselorReq: LoginCounselorReq, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.login(loginCounselorReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 약 검색
         ...
         * @throws {RequiredError}
         */
        searchMedication(keyword: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResListMedicationAutoCompleteDTO> {
            return localVarFp.searchMedication(keyword, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 복약 상담 조회
         ...
         * @throws {RequiredError}
         */
        selectByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResSelectByCounselSessionIdRes> {
            return localVarFp.selectByCounselSessionId(counselSessionId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 내담자 기본 정보 조회
         ...
         * @throws {RequiredError}
         */
        selectByCounselSessionId1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResSelectByCounselSessionIdRes> {
            return localVarFp.selectByCounselSessionId1(counselSessionId, counseleeId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 내담자 기본 정보 조회
         ...
         * @throws {RequiredError}
         */
        selectByCounselSessionId1_1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResSelectByCounselSessionIdRes> {
            return localVarFp.selectByCounselSessionId1_1(counselSessionId, counseleeId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 상담 카드 조회
         ...
         * @throws {RequiredError}
         */
        selectCounselCard_2(counselSessionId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResSelectCounselCardRes> {
            return localVarFp.selectCounselCard_2(counselSessionId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 상담일정 조회
         ...
         * @throws {RequiredError}
         */
        selectCounselSessionList(baseDate?: string, cursor?: string, size?: number, options?: RawAxiosRequestConfig): AxiosPromise<CommonCursorResListSelectCounselSessionListItem> {
            return localVarFp.selectCounselSessionList(baseDate, cursor, size, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 내담자 개인정보 수집 동의 여부 조회
         ...
         * @throws {RequiredError}
         */
        selectCounseleeConsent(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResSelectCounseleeConsentRes> {
            return localVarFp.selectCounseleeConsent(counselSessionId, counseleeId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 이전 복약 상담 조회
         ...
         * @throws {RequiredError}
         */
        selectPreviousByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResSelectPreviousByCounselSessionIdRes> {
            return localVarFp.selectPreviousByCounselSessionId(counselSessionId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 이전 상담 카드 조회
         ...
         * @throws {RequiredError}
         */
        selectPreviousItemListByCounselSessionId(counselSessionId: string, informationName: string, informationItemName: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResListSelectPreviousCounselCardItemListRes> {
            return localVarFp.selectPreviousItemListByCounselSessionId(counselSessionId, informationName, informationItemName, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 이전 상담 내역 조회
         ...
         * @throws {RequiredError}
         */
        selectPreviousListByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): AxiosPromise<CommonResListSelectPreviousListByCounselSessionIdRes> {
            return localVarFp.selectPreviousListByCounselSessionId(counselSessionId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 복약 상담 수정
         ...
         * @throws {RequiredError}
         */
        update(updateReq: UpdateReq, options?: RawAxiosRequestConfig): AxiosPromise<CommonResUpdateRes> {
            return localVarFp.update(updateReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 상담 카드 수정
...
export class DefaultApi extends BaseAPI {
    ...
    public _delete(deleteReq: DeleteReq, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration)._delete(deleteReq, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public add(addReq: AddReq, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).add(addReq, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public login(loginCounselorReq: LoginCounselorReq, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).login(loginCounselorReq, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public searchMedication(keyword: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).searchMedication(keyword, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectByCounselSessionId(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectByCounselSessionId1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectByCounselSessionId1(counselSessionId, counseleeId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectByCounselSessionId1_1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectByCounselSessionId1_1(counselSessionId, counseleeId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectCounselCard_2(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectCounselCard_2(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectCounselSessionList(baseDate?: string, cursor?: string, size?: number, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectCounselSessionList(baseDate, cursor, size, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectCounseleeConsent(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectCounseleeConsent(counselSessionId, counseleeId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectPreviousByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectPreviousByCounselSessionId(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectPreviousItemListByCounselSessionId(counselSessionId: string, informationName: string, informationItemName: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectPreviousItemListByCounselSessionId(counselSessionId, informationName, informationItemName, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public selectPreviousListByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).selectPreviousListByCounselSessionId(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public update(updateReq: UpdateReq, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).update(updateReq, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CounselCardControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async selectPreviousItemListByCounselSessionId(counselSessionId: string, informationName: string, informationItemName: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListSelectPreviousCounselCardItemListRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectPreviousItemListByCounselSessionId(counselSessionId, informationName, informationItemName, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounselCardControllerApi.selectPreviousItemListByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export class CounselCardControllerApi extends BaseAPI {
     ...
     */
    public selectPreviousItemListByCounselSessionId(counselSessionId: string, informationName: string, informationItemName: string, options?: RawAxiosRequestConfig) {
        return CounselCardControllerApiFp(this.configuration).selectPreviousItemListByCounselSessionId(counselSessionId, informationName, informationItemName, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CounselSessionControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async selectCounselSessionList(baseDate?: string, cursor?: string, size?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonCursorResListSelectCounselSessionListItem>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectCounselSessionList(baseDate, cursor, size, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounselSessionControllerApi.selectCounselSessionList']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async selectPreviousListByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListSelectPreviousListByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectPreviousListByCounselSessionId(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounselSessionControllerApi.selectPreviousListByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export class CounselSessionControllerApi extends BaseAPI {
     ...
     */
    public selectCounselSessionList(baseDate?: string, cursor?: string, size?: number, options?: RawAxiosRequestConfig) {
        return CounselSessionControllerApiFp(this.configuration).selectCounselSessionList(baseDate, cursor, size, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public selectPreviousListByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return CounselSessionControllerApiFp(this.configuration).selectPreviousListByCounselSessionId(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CounseleeConsentControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async selectCounseleeConsent(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectCounseleeConsentRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectCounseleeConsent(counselSessionId, counseleeId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounseleeConsentControllerApi.selectCounseleeConsent']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export class CounseleeConsentControllerApi extends BaseAPI {
     ...
     */
    public selectCounseleeConsent(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig) {
        return CounseleeConsentControllerApiFp(this.configuration).selectCounseleeConsent(counselSessionId, counseleeId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CounseleeControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async selectByCounselSessionId1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectByCounselSessionId1(counselSessionId, counseleeId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounseleeControllerApi.selectByCounselSessionId1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class CounseleeControllerApi extends BaseAPI {
     ...
     */
    public selectByCounselSessionId1(counselSessionId: string, counseleeId: string, options?: RawAxiosRequestConfig) {
        return CounseleeControllerApiFp(this.configuration).selectByCounselSessionId1(counselSessionId, counseleeId, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const CounselorControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addCounselor: async (addCounselorReq: AddCounselorReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(addCounselorReq, localVarRequestOptions, configuration)
...
export const CounselorControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addCounselor(addCounselorReq: AddCounselorReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addCounselor(addCounselorReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounselorControllerApi.addCounselor']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 로그인 처리, 헤더에 토큰 응답
        ...
        async login(loginCounselorReq: LoginCounselorReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.login(loginCounselorReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CounselorControllerApi.login']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const CounselorControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addCounselor(addCounselorReq: AddCounselorReq, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.addCounselor(addCounselorReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 로그인 처리, 헤더에 토큰 응답
         * @summary 로그인
...
export class CounselorControllerApi extends BaseAPI {
     ...
     */
    public addCounselor(addCounselorReq: AddCounselorReq, options?: RawAxiosRequestConfig) {
        return CounselorControllerApiFp(this.configuration).addCounselor(addCounselorReq, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public login(loginCounselorReq: LoginCounselorReq, options?: RawAxiosRequestConfig) {
        return CounselorControllerApiFp(this.configuration).login(loginCounselorReq, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MedicationControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async searchMedication(keyword: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListMedicationAutoCompleteDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchMedication(keyword, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MedicationControllerApi.searchMedication']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class MedicationControllerApi extends BaseAPI {
     ...
     */
    public searchMedication(keyword: string, options?: RawAxiosRequestConfig) {
        return MedicationControllerApiFp(this.configuration).searchMedication(keyword, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const MedicationCounselControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async _delete(deleteReq: DeleteReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResDeleteRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator._delete(deleteReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MedicationCounselControllerApi._delete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async add(addReq: AddReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResAddRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.add(addReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MedicationCounselControllerApi.add']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async selectByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectByCounselSessionId(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MedicationCounselControllerApi.selectByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async selectPreviousByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResSelectPreviousByCounselSessionIdRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.selectPreviousByCounselSessionId(counselSessionId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MedicationCounselControllerApi.selectPreviousByCounselSessionId']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async update(updateReq: UpdateReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResUpdateRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.update(updateReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MedicationCounselControllerApi.update']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class MedicationCounselControllerApi extends BaseAPI {
     ...
     */
    public _delete(deleteReq: DeleteReq, options?: RawAxiosRequestConfig) {
        return MedicationCounselControllerApiFp(this.configuration)._delete(deleteReq, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public add(addReq: AddReq, options?: RawAxiosRequestConfig) {
        return MedicationCounselControllerApiFp(this.configuration).add(addReq, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public selectByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return MedicationCounselControllerApiFp(this.configuration).selectByCounselSessionId(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public selectPreviousByCounselSessionId(counselSessionId: string, options?: RawAxiosRequestConfig) {
        return MedicationCounselControllerApiFp(this.configuration).selectPreviousByCounselSessionId(counselSessionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public update(updateReq: UpdateReq, options?: RawAxiosRequestConfig) {
        return MedicationCounselControllerApiFp(this.configuration).update(updateReq, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UserControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addUser: async (addUserReq: AddUserReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        login1: async (loginReq: LoginReq, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addUser(addUserReq: AddUserReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addUser(addUserReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async login1(loginReq: LoginReq, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.login1(loginReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UserControllerApi.login1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const UserControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addUser(addUserReq: AddUserReq, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.addUser(addUserReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 로그인 처리, 헤더에 토큰 응답
         * @summary 로그인
         ...
         * @throws {RequiredError}
         */
        login1(loginReq: LoginReq, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.login1(loginReq, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserControllerApi extends BaseAPI {
    ...
    public addUser(addUserReq: AddUserReq, options?: RawAxiosRequestConfig) {
        return UserControllerApiFp(this.configuration).addUser(addUserReq, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public login1(loginReq: LoginReq, options?: RawAxiosRequestConfig) {
        return UserControllerApiFp(this.configuration).login1(loginReq, options).then((request) => request(this.axios, this.basePath));
    }
}
