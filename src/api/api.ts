...
export type AddMedicationCounselReqCounselNeedStatusEnum = typeof AddMedicationCounselReqCounselNeedStatusEnum[keyof typeof AddMedicationCounselReqCounselNeedStatusEnum];
...
export type SelectMedicationCounselResCounselNeedStatusEnum = typeof SelectMedicationCounselResCounselNeedStatusEnum[keyof typeof SelectMedicationCounselResCounselNeedStatusEnum];
...
export type UpdateMedicationCounselReqCounselNeedStatusEnum = typeof UpdateMedicationCounselReqCounselNeedStatusEnum[keyof typeof UpdateMedicationCounselReqCounselNeedStatusEnum];
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addWasteMedicationRecord: async (counselSessionId: string, addAndUpdateWasteMedicationRecordReq: Array<AddAndUpdateWasteMedicationRecordReq>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'counselSessionId' is not null or undefined
            assertParamExists('addWasteMedicationRecord', 'counselSessionId', counselSessionId)
            // verify required parameter 'addAndUpdateWasteMedicationRecordReq' is not null or undefined
            assertParamExists('addWasteMedicationRecord', 'addAndUpdateWasteMedicationRecordReq', addAndUpdateWasteMedicationRecordReq)
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addWasteMedicationRecord(counselSessionId: string, addAndUpdateWasteMedicationRecordReq: Array<AddAndUpdateWasteMedicationRecordReq>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListAddAndUpdateWasteMedicationRecordRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addWasteMedicationRecord(counselSessionId, addAndUpdateWasteMedicationRecordReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.addWasteMedicationRecord']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addWasteMedicationRecord(counselSessionId: string, addAndUpdateWasteMedicationRecordReq: Array<AddAndUpdateWasteMedicationRecordReq>, options?: RawAxiosRequestConfig): AxiosPromise<CommonResListAddAndUpdateWasteMedicationRecordRes> {
            return localVarFp.addWasteMedicationRecord(counselSessionId, addAndUpdateWasteMedicationRecordReq, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 상담일정 삭제
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public addWasteMedicationRecord(counselSessionId: string, addAndUpdateWasteMedicationRecordReq: Array<AddAndUpdateWasteMedicationRecordReq>, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).addWasteMedicationRecord(counselSessionId, addAndUpdateWasteMedicationRecordReq, options).then((request) => request(this.axios, this.basePath));
    }
...
export const WasteMedicationControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async addWasteMedicationRecord(counselSessionId: string, addAndUpdateWasteMedicationRecordReq: Array<AddAndUpdateWasteMedicationRecordReq>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CommonResListAddAndUpdateWasteMedicationRecordRes>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addWasteMedicationRecord(counselSessionId, addAndUpdateWasteMedicationRecordReq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WasteMedicationControllerApi.addWasteMedicationRecord']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export class WasteMedicationControllerApi extends BaseAPI {
     ...
     */
    public addWasteMedicationRecord(counselSessionId: string, addAndUpdateWasteMedicationRecordReq: Array<AddAndUpdateWasteMedicationRecordReq>, options?: RawAxiosRequestConfig) {
        return WasteMedicationControllerApiFp(this.configuration).addWasteMedicationRecord(counselSessionId, addAndUpdateWasteMedicationRecordReq, options).then((request) => request(this.axios, this.basePath));
    }
